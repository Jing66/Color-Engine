...
public class ColorChoice extends JFrame implements ActionListener{
	...
	public ColorChoice() {
		...
		JButton addNew = new JButton("Add new Index");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source instanceof JButton){
			...
			JOptionPane.showMessageDialog(contentPane, "New Indicator Added! Please re-run the program! The new index will show at bottom!");
	...
	public void writeToDB(String index, String nickName){
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.print("Write to DB Failed");
		}
